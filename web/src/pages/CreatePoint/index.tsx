...
const CreatePoint = () =>{
    ...
    useEffect(()=>{
        axios.get<IProvince[]>('http://www.mwangosoft.com/api/provincia').then(response=>{
    ...
    useEffect(()=>{
        ...
        axios.get<ICounty[]>(`http://www.mwangosoft.com/api/municipio/${selectedProvince}`).then(response=>{
